...
import { HeaderMenu } from "./NavigateStyles";
...
function Navigate() {
  ...
  return (
    ...
    <div>
      ...
      {/* <div
        className={`hidden z-40 md:flex font-bold w-[740px] lg:w-[960px] xl:w-[1140px]  justify-between p-4 pl-0 fixed ${
          scroll > 200
